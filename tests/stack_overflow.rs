...
// since we do not want to actually panic but to pass the test successfully
    ...
    static ref TEST_IDT: InterruptDescriptorTable = {
        ...
        unsafe {
            idt.double_fault
                ...
                .set_stack_index(nit_os::interrupts::gdt::DOUBLE_FAULT_IST_INDEX);
        }
